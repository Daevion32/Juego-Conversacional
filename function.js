...
function initMap(){
   ...
   monkey[1][1] = {description:" Estas en la tienda de Stan , podrias comprarle algún objeto si tuvieses dinero", 
                   exits:["w","s"],
                   items:["Pala"]};
   ...
   monkey[3][0] = {description:"Si estas aqui , !Eureka! ya tienes todo lo necesario para salir de la isla", 
                   exits:["n","w"]};
   ...
   monkey[3][2] = {description:"Te hayas ante una sala con un escritorio y un mapa desplegado , si usas Mirar en el mapa veras una X en la isla   ,",
                   exits:["w"] ,
                   items:["Mapa con X"] };
...
function appendToOutput(text){
    ...
    const monkeyScroll = document.getElementById("description");
    monkeyScroll.scrollTop = monkeyScroll.scrollHeight;

}
/* Acabar de poner los items y hacer la funcion de coger . 
   hacer la funcion de mirar y de usar.
   seguir completando el juego con las funciones que faltan.
   Plantear el juego de warhammer*/